...
<body>
    <nav class="navbar navbar-expand-lg" id="navbar" data-bs-theme="dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?=base_url('Cliente')?>">Light System</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="navbar-item">
                        <a class="nav-link" href="<?=base_url('Cliente')?>">Home</a>
                    </li>

                    <li class="navbar-item">
                        <a class="nav-link" href="<?=base_url('Cliente/insert')?>">Adicionar cliente</a>
                    </li>
                </ul>
            </div>
        </div>
